class Blockchain(object):
    ...
    def proof_of_work(self, last_proof):
        ...
        you the consesus algorithm is implemented.


        It takes two parameters including self and
        last_proof
        """
    ...
    def hash(block):
        ...
        """
        The follow code will create a SHA-256 block 
        hash and also ensure that the dictionary is ordered
        """
